...
```{r explore 3, eval=FALSE, include=FALSE, fig.height=explore::total_fig_height(iris)}
iris %>% 
  explore::explore_all()
```


```{r explore 4, eval=FALSE, fig.height=explore::total_fig_height(iris, target = Species), explore::total_fig_height(iris, target=, include=FALSE}

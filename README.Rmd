...
[![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/sbalci/histopathR/master?urlpath=rstudio)
<!-- badges: end -->
...
```{r generate Clinicopathological Code Template, echo=TRUE, eval=FALSE}
